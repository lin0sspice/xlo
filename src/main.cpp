...
#if defined(NDEBUG)
# error "SOLOCOIN cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xbddc4c925e9884a23b34904b06f00419ec756c8f7b13e356ce7caba249388740");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // SOLOCOIN: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "SOLOCOIN Signed Message:\n";
...
{
    // SOLOCOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 150000 blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // SOLOCOIN: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // SOLOCOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbddc4c925e9884a23b34904b06f00419ec756c8f7b13e356ce7caba249388740");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1438354686, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "31/Jul/2015 SOLOCOIN 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1438354686;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3601896;
        ...
        assert(block.hashMerkleRoot == uint256("0x7a29686104b8e33dc8a8a526d33860d418337d7ab54aea34c543084fcfa691fe"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // SOLOCOIN: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SOLOCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SOLOCOINMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static SOLOCOINMiner(CWallet *pwallet)
{
    printf("SOLOCOINMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("solocoin-miner");
    ...
    try { loop {
        ...
        printf("Running SOLOCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("SOLOCOINMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&SOLOCOINMiner, pwallet));
}
